...
export function ContactCard({
	...
	return (
		...
		>
			...
			<Plus className="absolute -top-3 -left-3 h-6 w-6 text-primary" />
			<Plus className="absolute -top-3 -right-3 h-6 w-6 text-primary" />
			<Plus className="absolute -bottom-3 -left-3 h-6 w-6 text-primary" />
			<Plus className="absolute -right-3 -bottom-3 h-6 w-6 text-primary" />
