...
export default function HeroAltSection() {
	return (
		<div className="min-w-screen h-screen min-h-screen grid grid-cols-1 xl:grid-cols-2 relative 2xl:-translate-y-20 z-10">
			<div className="ml-10 absolute top-20 left-0 text-center xl:text-left z-10 opacity-100 h-full flex flex-col justify-center items-center xl:items-start gap-4 xl:gap-10">
